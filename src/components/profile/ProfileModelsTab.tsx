...
export default function ProfileModelsTab() {
  ...
  if (items.length === 0) {
    return (
      <div className="gallery-empty-state">
        <h3 className="gallery-empty-title">No models yet</h3>
        <p className="gallery-empty-subtitle">Upload a model to see it here.</p>
        <Link href="/models" className="gallery-generate-btn">
          Browse Models
        </Link>
      </div>
    );
