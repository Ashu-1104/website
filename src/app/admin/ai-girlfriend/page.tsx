...
const AdminAiGirlfriendPage = dynamic(() => import('@/components/admin/AdminAiGirlfriendPage'), { ssr: false });

export default function AdminAiGirlfriendRoute() {
  const { user } = useAuth();
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link href="/admin/ai-apps" className="admin-sidebar-link">
          ...
          <Link href="/admin/ai-girlfriend" className="admin-sidebar-link admin-sidebar-link-active">
