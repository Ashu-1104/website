...
const AdminCharactersPage = dynamic(() => import('@/components/admin/AdminCharactersPage'), { ssr: false });

export default function AdminCharactersRoute() {
  const { user } = useAuth();
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link href="/admin/characters" className="admin-sidebar-link admin-sidebar-link-active">
