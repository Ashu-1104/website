...
const AdminGalleryPage = dynamic(() => import('@/components/admin/AdminGalleryPage'), { ssr: false });
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link href="/admin/gallery" className="admin-sidebar-link admin-sidebar-link-active">
