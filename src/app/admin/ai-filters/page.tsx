...
const AdminAIFiltersPage = dynamic(() => import('@/components/admin/AdminAIFiltersPage'), { ssr: false });

export default function AdminAIFiltersRoute() {
  const { user } = useAuth();
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link href="/admin/ai-filters" className="admin-sidebar-link admin-sidebar-link-active">
