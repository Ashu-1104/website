...
const AdminVideoModelsPage = dynamic(() => import('@/components/admin/AdminVideoModelsPage'), { ssr: false });

export default function AdminVideoModelsRoute() {
  const { user } = useAuth();
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link href="/admin/video-models" className="admin-sidebar-link admin-sidebar-link-active">
