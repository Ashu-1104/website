...
const AdminModelsPage = dynamic(() => import('@/components/admin/AdminModelsPage'), { ssr: false });
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link href="/admin/models" className="admin-sidebar-link admin-sidebar-link-active">
