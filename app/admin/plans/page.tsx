...
const AdminPlansPage = dynamic(() => import('@/components/admin/AdminPlansPage'), { ssr: false });
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link href="/admin/plans" className="admin-sidebar-link admin-sidebar-link-active">
