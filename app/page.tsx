  ...
  return (
    <main className="app-shell">
      ...
      <header className="topbar">
        <a className="brand" href="#top"><span className="brand-mark">◈</span> uncensored<span>.art</span></a>
        <nav className={menuOpen ? "nav open" : "nav"}>
          <a href="#tools" onClick={() => setMenuOpen(false)}>Explore</a><a href="#models" onClick={() => setMenuOpen(false)}>Models</a><a href="#training" onClick={() => setMenuOpen(false)}>Training</a><a href="#faq" onClick={() => setMenuOpen(false)}>FAQ</a>
        </nav>
      ...
      <footer><a className="brand" href="#top"><span className="brand-mark">◈</span> uncensored<span>.art</span></a><span>© 2024 UncensoredArt.ai / Made for imagination.</span><div><a href="#contact">Instagram</a><a href="#contact">Discord</a><a href="#contact">X</a></div></footer>
    </main>
  )
}
